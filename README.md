...
<!--
  Screenshot: drop a PNG of the Now Playing tab at docs/screenshot.png and
  uncomment the line below.
  ![Track Kommander](docs/screenshot.png)
-->
...
what is written, what is deliberately not (`exportLibrary.db` is encrypted;
`PSSI` phrase data is absent, so the CDJ-3000 phrase view will be empty), and
how the blank database template is generated.
